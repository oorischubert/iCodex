    ...
    func body(content: Content) -> some View {
        content
            ...
            .alert("Hand off to Mac app", isPresented: $isShowingMacHandoffConfirm) {
                ...
                Text("iCodex will force close and reopen Codex.app on your Mac. Any desktop runs in progress will be stopped, and unsaved draft text there may be lost before this chat is opened.")
            }
            .alert(
