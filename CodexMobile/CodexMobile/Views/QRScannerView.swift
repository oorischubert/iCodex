...
struct QRScannerView: View {
    ...
    private func bridgeUpdateView(prompt: CodexBridgeUpdatePrompt) -> some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                bridgeUpdateStep(number: "1", title: "Refresh iCodex", detail: prompt.command, showsCopyButton: true)
                bridgeUpdateStep(number: "2", title: "Start it again", detail: AppEnvironment.sourceBridgeStartCommand)
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan QR code from iCodex bridge")
...
private final class QRCameraLifecycleCoordinator {
    ...
    private let queue = DispatchQueue(label: "com.icodex.qr-camera.lifecycle")
