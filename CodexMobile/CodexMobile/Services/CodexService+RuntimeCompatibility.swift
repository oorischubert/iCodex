...
private extension CodexService {
    var serviceTierBridgeUpdatePrompt: CodexBridgeUpdatePrompt {
        CodexBridgeUpdatePrompt(
            title: "Update iCodex on your Mac to use Speed controls",
            message: "This Mac bridge does not support the selected speed setting yet. Update your local iCodex bridge checkout to use Fast Mode and other speed controls.",
